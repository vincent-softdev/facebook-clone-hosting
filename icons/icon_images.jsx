...
const CommentIcon = (props) => {
    const url = "https://static.xx.fbcdn.net/rsrc.php/v3/yn/r/9l18rHILUYL.png"

    return (
        <i className={props.className} style={{backgroundImage: `url(${url})`, backgroundSize: `21px 1172px`, backgroundRepeat: `no-repeat`, display: `inline-block`, backgroundPosition: `0px -543px`}}>
...
const SendIcon = (props) => {
    ...
    return (
        <i className={props.className} style={{backgroundImage: `url(${url})`, backgroundSize: `21px 1172px`, backgroundRepeat: `no-repeat`, display: `inline-block`, backgroundPosition: `0px -399px`}}>
...
const ShareIcon = (props) => {
    ...
    return (
        <i className={props.className} style={{backgroundImage: `url(${url})`, backgroundSize: `21px 1172px`, backgroundRepeat: `no-repeat`, display: `inline-block`, backgroundPosition: `0px -859px`}}>
