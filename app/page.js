  ...
  return (
    <div className="w-full flex flex-col items-center">
      <div className="mt-5 w-full 2xl:w-[1464px] flex justify-center gap-10">
        ...
        <div
          id="middle-home"
          className="flex flex-col overflow-hidden gap-5 w-full max-w-[680px]"
        >
          <Stories />
          <div className="h-[100px] text-white p-4 bg-red-500 flex align-middle justify-center">
            Warning: please do not enter any personal information inside the
            post as all other users can view it
          </div>
          <Post />
        </div>
        <Contacts />
